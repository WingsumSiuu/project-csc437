import{i as n,x as h,r as l,p as y,t as f,b as v,n as o}from"./navbar-rDali1mL.js";var $=Object.defineProperty,p=(c,t,r,b)=>{for(var s=void 0,a=c.length-1,i;a>=0;a--)(i=c[a])&&(s=i(t,r,s)||s);return s&&$(t,r,s),s};const d=class d extends n{constructor(){super(...arguments),this.eggs=[]}connectedCallback(){super.connectedCallback(),this.src&&this.hydrate(this.src)}render(){return h`
            ${this.eggs.map(t=>h`
                <div class="shop-box">
